  ...
  <div>
    <form @submit="onSubmit" class="pt-2 pb-14">
      ...
      <fieldset class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" :disabled="loading">
        ...
        <FormField v-slot="{ componentField }" name="type_details.disc_count">
          <FormItem>
            <FormLabel icon="carbon:disc">Cantidad de discos</FormLabel>
            <FormControl>
              <Input
                type="number"
        ...
        <FormField
          ...
          name="type_details.has_bonus_content"
        >
          <FormItem class="flex items-center space-x-3 space-y-0">
            <FormControl>
              <Checkbox
            ...
            <FormLabel icon="carbon:gift">Contenido adicional</FormLabel>
          </FormItem>
        </FormField>

        <FormField
          v-slot="{ value, handleChange }"
          name="type_details.is_remastered"
        >
          <FormItem class="flex items-center space-x-3 space-y-0">
            <FormControl>
              <Checkbox
            ...
            <FormLabel icon="carbon:renew">Remasterizado</FormLabel>
          </FormItem>
        </FormField>
      </fieldset>
    </form>
  ...
  const formSchema = yup.object({
    ...
    type_details: yup
      .object({
        disc_count: yup
          .number()
          .typeError("El descuento del disco debe ser un número")
          .min(0, "El descuento del disco no puede ser negativo")
          .max(100, "El descuento del disco no puede ser mayor a 100")
          .optional(),
        has_bonus_content: yup
          .boolean()
          .typeError(
            "El campo de contenido adicional debe ser verdadero o falso",
          )
          .optional(),
        is_remastered: yup
          .boolean()
          .typeError("El campo de remasterización debe ser verdadero o falso")
          .optional(),
      })
